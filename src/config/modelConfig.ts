...
export const modelProviders: ModelProvider[] = [
  ...
  },
  {
    id: 'bedrock',
    name: 'AWS Bedrock',
    icon: 'ai-providers:aws',
    description: 'Use Bedrock models via SigV4 proxy (no credentials needed)',
    fields: [
      {
        name: 'proxyUrl',
        ...
        type: 'text',
        required: true,
        placeholder: 'https://bedrock.admin.dev.simons.disw.siemens.com',
        description: 'URL of the aws-sigv4-proxy service',
      },
      {
        name: 'model',
        label: 'Model',
